...
test.describe('bootstrapWorktree — inspectGitIdentity', () => {
    ...
    test.beforeAll(async () => {
        inspectGitIdentity = (await import('../../../../scripts/migrations/bootstrapWorktree.mjs')).inspectGitIdentity
    });
...
test.describe('#15337 bootstrapWorktree — configureAgentGitIdentity', () => {
    ...
    test.beforeAll(async () => {
        configureAgentGitIdentity =
            (await import('../../../../scripts/migrations/bootstrapWorktree.mjs')).configureAgentGitIdentity
    });
