...
test.describe('GitHub Workflow MCP Server Config Completeness', () => {
    ...
    test.beforeAll(async () => {
        ConfigProvider  = (await import('../../../../../cloud/ConfigProvider.mjs')).default;
    ...
    test('logger filters stderr by priority and always emits errors', async () => {
        const aiConfig = (await import('../../../../../mcp/server/github-workflow/config.template.mjs')).default;
        const logger   = (await import('../../../../../mcp/server/github-workflow/logger.mjs')).default;
