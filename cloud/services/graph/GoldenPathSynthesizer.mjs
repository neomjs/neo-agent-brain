...
class GoldenPathSynthesizer extends Base {
    ...
    async synthesizeGoldenPath({
        ...
        if (!routeFailure && routedTopNodes.length === 0 && !focusContradiction) {
            ...
            try {
                const {default: HealthService} = await import('../memory-core/HealthService.mjs');
...
`;
        ...
        try {
            const {renderConsumerFrictionSection} = await import('../memory-core/helpers/consumerFrictionHelper.mjs');
