...
test.describe('Knowledge Base release artifact — collection-scoped contract (#12157)', () => {
    ...
    test.beforeAll(async () => {
        ...
        } = await import('../../../../scripts/maintenance/knowledgeBaseArtifact.mjs'));

        ({uploadKnowledgeBase}   = await import('../../../../scripts/maintenance/uploadKnowledgeBase.mjs'));
        ({downloadKnowledgeBase} = await import('../../../../scripts/maintenance/downloadKnowledgeBase.mjs'));
