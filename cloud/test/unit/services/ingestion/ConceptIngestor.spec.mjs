...
import os                                      from 'os';
import {snapshotAiConfig, TestLifecycleHelper} from '../memory-core/util.mjs';
...
test.describe('Neo.ai.daemons.services.ConceptIngestor', () => {
    ...
    test.beforeAll(async () => {
        ...
        ConceptIngestor        = (await import('../../../../services/ingestion/ConceptIngestor.mjs')).default;
        ConceptService         = (await import('../../../../services/ConceptService.mjs')).default;
