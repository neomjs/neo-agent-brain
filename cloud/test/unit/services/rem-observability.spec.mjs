...
test.describe('ai/services REM observability axis helpers (#12068 Sub 2 Part A)', () => {
    ...
    test.beforeAll(async () => {
        ...
        TopologyInferenceEngine = (await import('../../../services/graph/TopologyInferenceEngine.mjs')).default;
    ...
    test.describe('Memory Core MCP get_rem_pipeline_state', () => {
        ...
        test('#13458: a stalled REM axis returns a bounded numeric fallback plus axisErrors', async () => {
            ...
            try {
                const {buildRemPipelineState} = await import('../../../services/memory-core/HealthService.mjs');
