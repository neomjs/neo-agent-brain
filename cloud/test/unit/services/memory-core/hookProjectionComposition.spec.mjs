...
test.describe('hookProjection — the lease and the transport, actually composed', () => {
    ...
    test.beforeAll(async () => {
        const lease     = await import('../../../../services/memory-core/hookProjectionLease.mjs'),
              submitMod = await import('../../../../services/memory-core/hookProjectionSubmission.mjs'),
              transport = await import('../../../../services/memory-core/hookProjectionTransport.mjs');
