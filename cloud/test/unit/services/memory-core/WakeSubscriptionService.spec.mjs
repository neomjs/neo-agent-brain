...
import {buildWakeReceiverManifest} from '../../../../../daemons/wake/buildReceiverManifest.mjs';
...
test.describe('Neo.ai.services.memory-core.WakeSubscriptionService', () => {
    ...
    test.beforeAll(async () => {
        ...
        WakeSubscriptionService = (await import('../../../../services/memory-core/WakeSubscriptionService.mjs')).default;
        ...
        CoalescingEngineService = (await import('../../../../services/memory-core/CoalescingEngineService.mjs')).default;
        WebhookDeliveryService  = (await import('../../../../services/memory-core/WebhookDeliveryService.mjs')).default;
        ...
        const GraphMaintenanceService = (await import('../../../../services/graph/GraphMaintenanceService.mjs')).default;
    ...
    test.describe('who_is_online (#13498 Substrate B)', () => {
        ...
        test('stale provider validation stamps only the matching identity and clears on the next projection', async () => {
            const {getAuthValidationStaleness} = await import('../../../../mcp/server/shared/services/AuthService.mjs'),
