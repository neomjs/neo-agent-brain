...
import {appendWalEmbedMarker, readPendingWalRecords} from '../../../../services/memory-core/helpers/memoryWalStore.mjs';
import {drainMemoryWal}                              from './util.mjs';
import {getProviderActivityContext}                  from '../../../../services/shared/providerActivityLedger.mjs';
...
test.describe('Neo.ai.services.memory-core.MemoryService.writeAhead', () => {
    ...
    test.beforeAll(async () => {
        ...
        ({default: MemoryService, MEMORY_ACCEPTED_MESSAGE} =
            await import('../../../../services/memory-core/MemoryService.mjs'));
        ...
        TurnPresenceService  = (await import('../../../../services/memory-core/TurnPresenceService.mjs')).default;
