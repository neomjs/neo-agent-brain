...
} from '../../../../../services/memory-core/helpers/restoreEmptyTargetOperation.mjs';
import {
    admitRestoreTargetSetBundle
} from '../../../../../services/memory-core/helpers/restoreTargetSetAdmission.mjs';
import {
    createRestoreTargetSetStorage
} from '../../../../../services/memory-core/helpers/restoreTargetSetStorage.mjs';
import {
...
test.describe('restoreTargetSetStorage — fake Chroma + disposable SQLite target set', () => {
    ...
    test('an election landing during staging fences every vector promote of that attempt (#17035)', async () => {
        ...
        } = await import('../../../../../services/shared/vector/generationElectionStore.mjs');
...
test.describe('restoreTargetSetStorage — live disposable Chroma + SQLite target set', () => {
    ...
    test.beforeAll(async () => {
        [
            ...
            import('../../../../../mcp/server/memory-core/config.template.mjs'),
            import('../../../../../services/memory-core/managers/ChromaManager.mjs')
        ]);
