...
import os              from 'os';
import {getPaths}      from '../../../../graph/queries/traversal.mjs';
import {
...
test.describe('Neo.ai.services.memory-core.GraphService', () => {
    ...
    test.beforeAll(async () => {
        ...
        const graphModule = await import('../../../../services/memory-core/GraphService.mjs');
    ...
    test('getNodeRecord applies the #10011 RLS visibility re-check (#11637)', async () => {
        test.skip(!!process.env.NEO_TEST_SKIP_CI, 'CI-skip: SqliteError disk I/O - bucket G3 (#10924)');
        const RequestContextService = (await import('../../../../mcp/server/shared/services/RequestContextService.mjs')).default;
    ...
    test('preBriefSession should hydrate episodic context through getNeighbors semanticVectorId', async () => {
        ...
        const StorageRouter = (await import('../../../../services/memory-core/managers/StorageRouter.mjs')).default;
        const MemoryService = (await import('../../../../services/memory-core/MemoryService.mjs')).default;
    ...
    test('linkNodesAsync back-fills missing memory: target via MemorySessionIngestor', async () => {
        const MemorySessionIngestor = (await import('../../../../services/ingestion/MemorySessionIngestor.mjs')).default;
    ...
    test('ensureGlobalBootSeedNode restores an absent hub from the manifest, idempotently (#15985)', async () => {
        const {getGraphBootSeedNodeSpec} = await import('../../../../graph/bootSeedManifest.mjs');
    ...
    test('ensureGlobalBootSeedNode REPAIRS a present-but-invalid seed, not just an absent one (#15985)', async () => {
        const RequestContextService      = (await import('../../../../mcp/server/shared/services/RequestContextService.mjs')).default,
              {getGraphBootSeedNodeSpec} = await import('../../../../graph/bootSeedManifest.mjs');
