...
test.describe('The sender\'s discriminator agrees with what the receiver actually answers (#16366)', () => {
    ...
    test.beforeAll(async () => {
        WebhookDeliveryService = (await import('../../../../services/memory-core/WebhookDeliveryService.mjs')).default;
        createWakeReceiver     = (await import('../../../../../daemons/wake/receiver.mjs')).createWakeReceiver;
        WakeReceiverState      = (await import('../../../../../daemons/wake/receiverState.mjs')).WakeReceiverState;
    });
