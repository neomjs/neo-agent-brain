...
export async function resetMemoryCoreLifecycle(SDK) {
    ...
    if (SDK) {
        ...
        ChromaManager    = (await import('../../../../services/memory-core/managers/ChromaManager.mjs')).default;
        LifecycleService = (await import('../../../../services/memory-core/lifecycle/SystemLifecycleService.mjs')).default;
        MemoryService    = (await import('../../../../services/memory-core/MemoryService.mjs')).default;
...
export async function drainMemoryWal({ids, collection, SDK} = {}) {
    const aiConfig       = SDK?.Memory_Config ?? (await import('../../../../mcp/server/memory-core/config.template.mjs')).default;
    const StorageRouter  = SDK?.Memory_StorageRouter ?? (await import('../../../../services/memory-core/managers/StorageRouter.mjs')).default;
    const {drainWalOnce} = await import('../../../../daemons/embed/drainCycle.mjs');
