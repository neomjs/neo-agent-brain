...
import ChromaManager               from '../../../../services/memory-core/managers/ChromaManager.mjs';
...
test.describe('HealthService #10176 — buildIdentityBlock', () => {
    ...
    test.beforeAll(async () => {
        const mod = await import('../../../../services/memory-core/HealthService.mjs');
...
test.describe('HealthService #13312 — startup dependency observability', () => {
    ...
    test.beforeAll(async () => {
        HealthService = (await import('../../../../services/memory-core/HealthService.mjs')).default;
    });
...
test.describe('HealthService #12382 — cached healthcheck freshness', () => {
    ...
    test.beforeAll(async () => {
        const healthModule = await import('../../../../services/memory-core/HealthService.mjs');
...
test.describe('EmbeddingProviderConfig #11596 — resolveEmbeddingProvider', () => {
    ...
    test.beforeAll(async () => {
        const mod = await import('../../../../services/memory-core/helpers/embeddingProviderConfig.mjs');
...
test.describe('HealthService #16310 — wake subscription arming verdict', () => {
    ...
    test.beforeAll(async () => {
        buildWakeFeaturesBlock    = (await import('../../../../services/memory-core/HealthService.mjs')).buildWakeFeaturesBlock;
        RequestContextService     = (await import('../../../../mcp/server/shared/services/RequestContextService.mjs')).default;
        WakeSubscriptionService   = (await import('../../../../services/memory-core/WakeSubscriptionService.mjs')).default;
        buildWakeReceiverManifest = (await import('../../../../../daemons/wake/buildReceiverManifest.mjs')).buildWakeReceiverManifest;
