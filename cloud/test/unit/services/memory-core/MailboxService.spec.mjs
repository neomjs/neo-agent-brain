...
import {collisionPreventionTag} from '../../../../services/shared/a2aCollisionTags.mjs';
...
test.describe('Neo.ai.services.memory-core.MailboxService', () => {
    ...
    test.beforeAll(async () => {
        ...
        mailboxAiConfig = (await import('../../../../mcp/server/memory-core/config.template.mjs')).default;

        // Load dynamically due to SQLite DB mount timing
        GraphService = (await import('../../../../services/memory-core/GraphService.mjs')).default;
        MailboxService = (await import('../../../../services/memory-core/MailboxService.mjs')).default;
        getWakeDeliverySeries = (await import('../../../../services/memory-core/MailboxService.mjs')).getWakeDeliverySeries;
        readBackgroundDeliveryState = (await import('../../../../services/memory-core/MailboxService.mjs')).readBackgroundDeliveryState;
        readMessageWalSegmentLoadObservations = (await import('../../../../services/memory-core/MailboxService.mjs')).readMessageWalSegmentLoadObservations;
        PermissionService = (await import('../../../../services/memory-core/PermissionService.mjs')).default;
        LifecycleService = (await import('../../../../services/memory-core/lifecycle/SystemLifecycleService.mjs')).default;
        SwarmHeartbeatService = (await import('../../../../daemons/orchestrator/services/SwarmHeartbeatService.mjs')).default;
        buildMailboxDelta = (await import('../../../../services/memory-core/MemoryService.mjs')).buildMailboxDelta;
        callMemoryCoreTool = (await import('../../../../mcp/server/memory-core/toolService.mjs')).callTool;
        const messageWalStore = await import('../../../../services/memory-core/helpers/messageWalStore.mjs');
    ...
    test('#15913 markRead all mode drains one unpaginated direct+broadcast snapshot and preserves carrier ownership', async () => {
        ...
        const {callTool: listTool} = await import('../../../../mcp/server/memory-core/toolService.mjs');
    ...
    test('#15913 markRead all mode excludes post-snapshot arrivals and reports only exceptional rows', async () => {
        ...
        // snapshot one.
        const {callTool: seedListTool} = await import('../../../../mcp/server/memory-core/toolService.mjs');
    ...
    test('#17321 listing a 120-message backlog still clears it in ONE call — the motivating case', async () => {
        ...
        const {callTool: backlogTool} = await import('../../../../mcp/server/memory-core/toolService.mjs');
    ...
    test('#17321 the receipt reports what it withheld, so a narrower drain is never silent', async () => {
        const {callTool: withheldTool} = await import('../../../../mcp/server/memory-core/toolService.mjs');
    ...
    test('#17321 a FAILED seen write leaves cache and storage coherent, and the next listing RETRIES', async () => {
        ...
        const
            {callTool}  = await import('../../../../mcp/server/memory-core/toolService.mjs'),
    ...
    test('a FULL re-projection over an existing read DM preserves the committed readAt — the write choke-point is caller-proof (#14992)', async () => {
        ...
        const {readWalMessagesByIds} = await import('../../../../services/memory-core/helpers/messageWalStore.mjs');
