...
import {BATCH_SCHEMA_VERSION} from '../../../../services/memory-core/communityBatchContract.mjs';
...
test.describe('Neo.ai.services.memory-core.CommunityBatchAdmissionService', () => {
    ...
    test.beforeAll(async () => {
        ...
        SourceRegistryService = (await import('../../../../services/memory-core/SourceRegistryService.mjs')).default;
        AdmissionService      = (await import('../../../../services/memory-core/CommunityBatchAdmissionService.mjs')).default;
