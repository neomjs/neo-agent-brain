...
test.describe('lmsExecOptions — embedding-readiness PATH fix', () => {
    ...
    test.beforeAll(async () => {
        const mod = await import('../../../../services/graph/providerReadinessHelper.mjs');
...
test.describe('LM Studio residency mutation queue (#17054)', () => {
    ...
    test.beforeAll(async () => {
        ({ensureLmsModelsLoaded, loadLmsModel} = await import('../../../../services/graph/providerReadinessHelper.mjs'));
    });
