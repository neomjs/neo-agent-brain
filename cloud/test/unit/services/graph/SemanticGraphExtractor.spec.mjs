...
import {readActiveRemCallState} from '../../../../services/memory-core/helpers/remRunStateStore.mjs';
...
test.describe('Neo.ai.daemons.services.SemanticGraphExtractor', () => {
    ...
    test.beforeAll(async () => {
        rootAiConfig = (await import('../../../../config.template.mjs')).default;
    ...
    test('REM marathon raw-turn path exposes active diagnostics and output budget before provider return (#13984)', async () => {
        const MemoryCoreRecorderService = (await import('../../../../services/memory-core/MemoryCoreRecorderService.mjs')).default;
        const originalOverrides         = {
