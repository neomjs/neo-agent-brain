...
test.describe('lifecycleAdmission — the five stages and their exclusions', () => {
    ...
    test.beforeAll(async () => {
        ...
        } = await import('../../../../services/graph/lifecycleAdmission.mjs'));
        ({normalizeLifecycleClocks: normalizeClocks} = await import('../../../../services/graph/lifecycleAdmission.mjs'));
    });
    ...
    test('the SAME subject moving head A → clear → head B carries no clock across the transition', async () => {
        const {normalizeLifecycleClocks} = await import('../../../../services/graph/lifecycleAdmission.mjs');
