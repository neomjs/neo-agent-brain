...
test.describe('fleetActivityComposer — composing two truths means composing two capabilities', () => {
    ...
    test.beforeAll(async () => {
        const mod = await import('../../../../services/fleet/fleetActivityComposer.mjs');
...
test.describe('fleetActivityComposer ↔ FleetControlBridge — the real consumer calls the real producer', () => {
    ...
    test.beforeAll(async () => {
        FleetControlBridge           = (await import('../../../../services/fleet/FleetControlBridge.mjs')).default;
        createFleetActivityReadSource = (await import('../../../../services/fleet/fleetActivityComposer.mjs')).createFleetActivityReadSource
    });
