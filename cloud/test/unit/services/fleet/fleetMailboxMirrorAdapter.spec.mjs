...
import * as adapterModule from '../../../../services/fleet/fleetMailboxMirrorAdapter.mjs'
import {
    createFleetMailboxMirrorSnapshot,
    DEFAULT_FLEET_MAILBOX_MIRROR_LIMIT,
    MAX_FLEET_MAILBOX_MIRROR_LIMIT,
    readFleetMailboxMirror
} from '../../../../services/fleet/fleetMailboxMirrorAdapter.mjs'
...
test.describe('fleetMailboxMirrorAdapter — real MailboxService producer contract', () => {
    ...
    test.beforeAll(async () => {
        ...
        mirrorAiConfig = (await import('../../../../mcp/server/memory-core/config.template.mjs')).default
