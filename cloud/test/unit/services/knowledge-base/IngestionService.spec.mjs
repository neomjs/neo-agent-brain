...
import aiConfig       from '../../../../mcp/server/knowledge-base/config.template.mjs';
import {
...
test.describe('IngestionService.ingestSourceFiles', () => {
    ...
    test.beforeAll(async () => {
        Service = (await import('../../../../services/knowledge-base/IngestionService.mjs')).default;
        SafeService = (await import('../../../../services.mjs')).KB_IngestionService;
    });
