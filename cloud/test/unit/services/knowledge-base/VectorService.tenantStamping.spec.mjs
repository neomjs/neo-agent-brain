...
test.describe('VectorService.embed — tenant stamping (#11631)', () => {
    ...
    test.beforeAll(async () => {
        ...
        const VectorServiceModule   = await import('../../../../services/knowledge-base/VectorService.mjs');
        const DatabaseServiceModule = await import('../../../../services/knowledge-base/DatabaseService.mjs');
        const LoggerModule          = await import('../../../../mcp/server/knowledge-base/logger.mjs');
