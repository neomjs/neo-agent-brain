...
test.beforeAll(async () => {
    ...
    ({default: aiConfig}       = await import('../../../../mcp/server/knowledge-base/config.template.mjs'));
    ({CHROMA_PRODUCTION_DATABASE} = await import('../../../../services/shared/vector/chromaTestIsolation.mjs'));
});
