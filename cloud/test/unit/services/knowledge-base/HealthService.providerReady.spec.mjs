...
test.describe('Neo.ai.services.knowledge-base.HealthService observed embedding readiness (#16691)', () => {
    ...
    test.beforeAll(async () => {
        const healthModule = await import('../../../../services/knowledge-base/HealthService.mjs');
        ...
        DatabaseLifecycleService                 = (await import('../../../../services/knowledge-base/DatabaseLifecycleService.mjs')).default;
    });
...
test.describe('Neo.ai.services.knowledge-base.HealthService stale collection handle recovery (#13464)', () => {
    ...
    test.beforeAll(async () => {
        HealthService            = (await import('../../../../services/knowledge-base/HealthService.mjs')).default;
        ChromaManager            = (await import('../../../../services/knowledge-base/ChromaManager.mjs')).default;
        DatabaseLifecycleService = (await import('../../../../services/knowledge-base/DatabaseLifecycleService.mjs')).default;
    });
