...
test.describe('Neo.ai.services.knowledge-base.SearchService', () => {
    ...
    test.beforeAll(async () => {
        aiConfig      = (await import('../../../../mcp/server/knowledge-base/config.template.mjs')).default;
        QueryService  = (await import('../../../../services/knowledge-base/QueryService.mjs')).default;
        SearchService = (await import('../../../../services/knowledge-base/SearchService.mjs')).default;
    ...
    test('composes query embedding before synthesis and skips synthesis on an empty result', async () => {
        const
            ChromaManager                  = (await import('../../../../services/knowledge-base/ChromaManager.mjs')).default,
    ...
    test('ask names the download/sync one-liners when the collection is EMPTY (post npm-prepare decouple cold-start)', async () => {
        const ChromaManager         = (await import('../../../../services/knowledge-base/ChromaManager.mjs')).default;
    ...
    test('#16932: an ask.baseUrl override gets the LOCAL host and NO inherited Tier-1 key', async () => {
        const {buildAskProviderConfigs} = await import('../../../../services/knowledge-base/SearchService.mjs');
    ...
    test('the queue is actually HANDED to buildChatModel — not merely constructible', async () => {
        ...
        const {buildAskChatModelOptions} = await import('../../../../services/knowledge-base/SearchService.mjs'),
    ...
    test('ask owns an admission queue sized by maxParallel, defaulting to serialized', async () => {
        const {buildAskRequestQueue} = await import('../../../../services/knowledge-base/SearchService.mjs');
