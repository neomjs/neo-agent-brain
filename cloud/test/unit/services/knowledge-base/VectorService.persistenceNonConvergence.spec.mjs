...
test.describe('VectorService — persistence failure is an unbounded re-embed loop', () => {
    ...
    test.beforeAll(async () => {
        ...
        MC_Config            = (await import('../../../../mcp/server/memory-core/config.template.mjs')).default;
        ...
        ({selectResumableChunks} = await import('../../../../services/knowledge-base/helpers/resumableEmbedding.mjs'));
        ({ensureEmbeddingIdentitySchema, getEmbeddingIdentityWindow} =
            await import('../../../../services/shared/embeddingIdentityLedger.mjs'));
