...
test.describe('KnowledgeBase — fail-closed tenant isolation (#11632)', () => {
    ...
    test.beforeAll(async () => {
        ...
        DocumentService      = (await import('../../../../services/knowledge-base/DocumentService.mjs')).default;
        ...
        VectorService        = (await import('../../../../services/knowledge-base/VectorService.mjs')).default;
