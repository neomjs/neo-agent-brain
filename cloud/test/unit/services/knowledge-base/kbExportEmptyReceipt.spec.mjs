...
test.describe('KB export receipt on an empty collection', () => {
    ...
    test.beforeAll(async () => {
        ({default: DatabaseService} = await import('../../../../services/knowledge-base/DatabaseService.mjs'));
        ({default: ChromaManager}   = await import('../../../../services/knowledge-base/ChromaManager.mjs'));
