...
import {assertConfigFresh, collectStaleOverlayFindings, detectTier1OverlayDrift, initTier1Config,
        projectSourceShape, projectTier1DefaultsShape, stripSourceComments} from '../../../scripts/setup/initServerConfigs.mjs';
import {renderOverlayModule, writeMigratedOverlay} from '../../../scripts/setup/migrateConfigOverlay.mjs';
