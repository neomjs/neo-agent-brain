...
test.beforeAll(async () => {
    const bridge = await import('../../../../daemons/orchestrator/services/DeploymentStateBridgeService.mjs');
    ...
    ({CONTAINER_HEALTH_FACT_TYPES} = await import(
        '../../../../daemons/orchestrator/services/ContainerHealthDiagnosisService.mjs'));
});
