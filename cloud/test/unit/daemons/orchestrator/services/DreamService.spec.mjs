...
import {computeSessionTurnInputRevision} from '../../../../../services/memory-core/helpers/turnDocumentText.mjs';
import {NL_ACTION_TELEMETRY_NODE_TYPE}   from '../../../../../services/memory-core/helpers/nlActionTelemetryStore.mjs';
import {
...
test.describe('Neo.ai.services.memory-core.DreamService', () => {
    ...
    test.beforeAll(async () => {
        aiConfig = (await import('../../../../../mcp/server/memory-core/config.template.mjs')).default;
        ...
        DreamService = (await import('../../../../../daemons/orchestrator/services/DreamService.mjs')).default;
        MemorySessionIngestor = (await import('../../../../../services/ingestion/MemorySessionIngestor.mjs')).default;
        SemanticGraphExtractor = (await import('../../../../../services/graph/SemanticGraphExtractor.mjs')).default;
        StorageRouter = (await import('../../../../../services/memory-core/managers/StorageRouter.mjs')).default;
        OpenAiCompatible       = (await import('../../../../../provider/OpenAiCompatible.mjs')).default;
        SystemLifecycleService = (await import('../../../../../services/memory-core/lifecycle/SystemLifecycleService.mjs')).default;
        TextEmbeddingService   = (await import('../../../../../services/memory-core/TextEmbeddingService.mjs')).default;
        KBRecorderService      = (await import('../../../../../services/knowledge-base/KBRecorderService.mjs')).default;
        logger                 = (await import('../../../../../mcp/server/memory-core/logger.mjs')).default;
    ...
    test('findUndigestedSessions fails loud when remSleepBatchLimit is malformed in the imported config', async () => {
        const aiConfig                   = (await import('../../../../../mcp/server/memory-core/config.template.mjs')).default,
    ...
    test('processUndigestedSessions calls inferTestGapsFromSession per-session and inferConceptGraphGaps once per cycle (hoist contract — #10085)', async () => {
        ...
        const aiConfig                = (await import('../../../../../mcp/server/memory-core/config.template.mjs')).default;
        const AdrIngestor             = (await import('../../../../../services/ingestion/AdrIngestor.mjs')).default;
        const ConceptIngestor         = (await import('../../../../../services/ingestion/ConceptIngestor.mjs')).default;
        const FileSystemIngestor      = (await import('../../../../../services/memory-core/FileSystemIngestor.mjs')).default;
        const TopologyInferenceEngine = (await import('../../../../../services/graph/TopologyInferenceEngine.mjs')).default;
    ...
    test('TopologyInferenceEngine classifies non-empty invalid topology output as parse failure (#13995)', async () => {
        ...
        } = await import('../../../../../services/memory-core/helpers/consumerFrictionHelper.mjs');
