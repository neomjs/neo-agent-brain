...
test.describe('Neo.ai.daemons.SwarmHeartbeatService', () => {
    ...
    test.beforeAll(async () => {
        const swarmHeartbeatModule = await import('../../../../../daemons/orchestrator/services/SwarmHeartbeatService.mjs');
        ...
        const wakeSubscriptionModule = await import('../../../../../services/memory-core/WakeSubscriptionService.mjs');
        ...
        const mailboxModule = await import('../../../../../services/memory-core/MailboxService.mjs');
        MailboxService         = mailboxModule.default;
        originalListMessages   = MailboxService.listMessages;

        const contextModule = await import('../../../../../mcp/server/shared/services/RequestContextService.mjs');
    ...
    test('getReadinessSentinelMessages binds RequestContextService identity AND returns listMessages summaries that decideWake honors (PR #11999 cycle-2)', async () => {
        ...
        const wakeDecisionModule    = await import('../../../../../daemons/orchestrator/services/WakeDecisionService.mjs');
