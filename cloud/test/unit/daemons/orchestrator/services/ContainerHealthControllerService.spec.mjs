...
} from '../../../../../daemons/orchestrator/services/ContainerHealthControllerService.mjs';
import {
    CONTAINER_HEALTH_ACTION_CLASSES,
    ContainerHealthDiagnosisService
} from '../../../../../daemons/orchestrator/services/ContainerHealthDiagnosisService.mjs';
import {RecoveryActuatorService} from '../../../../../daemons/orchestrator/services/RecoveryActuatorService.mjs';
import {
    appendHealEvent,
...
test.describe('Neo.ai.daemons.services.ContainerHealthControllerService', () => {
    ...
    test('a running heavy task declines a warm-provider decision before provider repair', async () => {
        const {Orchestrator} = await import('../../../../../daemons/orchestrator/Orchestrator.mjs'),
