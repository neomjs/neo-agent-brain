...
import {buildEmbeddingProbeInput} from '../../../../../services/shared/embeddingProbe.mjs';
...
import {classifyEmbeddingRecoveryState, isRepoDue, resolveUnknownRepoSelectorFailure, YIELD_CAUSE_LEASE}
                            from '../../../../../daemons/orchestrator/scheduling/tenantRepoSync.mjs';
import {
...
} from '../../../../../daemons/orchestrator/services/tenantRepoCheckpointValidity.mjs';
import {TENANT_REPO_SYNC_ERROR_CODES}
    from '../../../../../daemons/orchestrator/services/TenantRepoSyncErrors.mjs';
import {deriveTenantRepoMirrorPath} from '../../../../../services/knowledge-base/helpers/tenantRepoAccessContract.mjs';
...
} from '../../../../../scripts/maintenance/syncTenantRepos.mjs';
import {readHealLedger}        from '../../../../../services/memory-core/helpers/healEventLedgerStore.mjs';
import MemoryCoreConfig        from '../../../../../mcp/server/memory-core/config.template.mjs';
...
test.describe('TenantRepoSyncService (#11790)', () => {
    ...
    test('a fence-only REAL receipt writer proves completion through runTask (#17440)', async () => {
        const
            {default: IngestionService} = await import(
                '../../../../../services/knowledge-base/IngestionService.mjs'
            ),
            taskStateService = createInMemoryTaskStateService(),
            manifests        = new Map(),
    ...
    test('an OpenAI-compatible provider timeout stops the queued repo in this sweep and a fresh sweep dispatches it', async () => {
        const
            {default: embeddingConfig} = await import(
                '../../../../../mcp/server/memory-core/config.template.mjs'
            ),
    ...
    test('real embed failures reach details.repos[] as distinct source codes (#16647, #16658)', async () => {
        ...
        const
            {default: TextEmbeddingService} = await import(
                '../../../../../services/memory-core/TextEmbeddingService.mjs'
            ),
            {default: embeddingConfig} = await import(
                '../../../../../mcp/server/memory-core/config.template.mjs'
            ),
    ...
    test('#17439 K=2 composes real Vector resume and cumulative settlement through completion', async () => {
        const
            SDK                                                                  = await import('../../../../../services.mjs'),
            {default: VectorService}                                             = await import('../../../../../services/knowledge-base/VectorService.mjs'),
    ...
    test('a clean slice CLEARS an inherited streak, while an error-bearing one still accrues it (#17349)', async () => {
        ...
        const {TENANT_REPO_INGEST_CONTRACT_VERSION: contractVersion} =
            await import('../../../../../daemons/orchestrator/services/tenantRepoCheckpointValidity.mjs');
...
test.describe('the persisted cause DISCRIMINATES, and still leaks nothing (#16056)', () => {
    ...
    test('four different causes classify four different ways', async () => {
        const {classifyTenantRepoAccessFailure, TenantRepoAccessCode} =
            await import('../../../../../services/knowledge-base/helpers/tenantRepoAccessContract.mjs');
