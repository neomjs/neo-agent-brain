...
test.describe('Neo.ai.daemons.KbAlertingService (#11642)', () => {
    ...
    test.beforeAll(async () => {
        ({default: KbAlertingService} =
            await import('../../../../daemons/kb-alerting/KbAlertingService.mjs'));
        ...
        logger                = (await import('../../../../mcp/server/knowledge-base/logger.mjs')).default;

        const KBRecorderService = (await import('../../../../services/knowledge-base/KBRecorderService.mjs')).default;
