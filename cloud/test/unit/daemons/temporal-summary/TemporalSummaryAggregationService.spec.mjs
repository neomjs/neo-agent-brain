...
test.describe('Neo.ai.daemons.TemporalSummaryAggregationService', () => {
    ...
    test.beforeAll(async () => {
        TemporalSummaryAggregationService = (await import('../../../../daemons/temporal-summary/TemporalSummaryAggregationService.mjs')).default;
        ...
        GraphService                      = (await import('../../../../services.mjs')).Memory_GraphService;
