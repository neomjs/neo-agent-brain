...
test.describe('ingest_source_files MCP facade — work-volume gate (#11634)', () => {
    ...
    test.beforeAll(async () => {
        const toolService = await import('../../../../../mcp/server/knowledge-base/toolService.mjs');
        const ingestTool  = await import('../../../../../mcp/server/knowledge-base/ingestSourceFilesTool.mjs');
        callTool               = toolService.callTool;
        ingestSourceFilesViaMcp = ingestTool.ingestSourceFilesViaMcp;
        listTools               = toolService.listTools;

        IngestionService = (await import('../../../../../services/knowledge-base/IngestionService.mjs')).default;
