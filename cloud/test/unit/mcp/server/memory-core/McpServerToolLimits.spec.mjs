...
test.describe('Neo.ai.mcp.server.memory-core Tool limits', () => {
    ...
    test.beforeAll(async () => {
        ...
        const ToolServiceModule = await import('../../../../../mcp/server/memory-core/toolService.mjs');
        toolService = {
    ...
    test('healthcheck DECLARES memoryWalDrain, and every key its real producer returns is in the schema (#16060)', async () => {
        ...
        const {default: MemoryService} = await import('../../../../../services/memory-core/MemoryService.mjs'),
