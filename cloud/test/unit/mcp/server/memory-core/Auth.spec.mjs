...
test.describe('Neo.ai.mcp.server.shared.services.StdioIdentityResolver', () => {
    ...
    test.beforeAll(async () => {
        StdioIdentityResolver    = (await import('../../../../../mcp/server/shared/services/StdioIdentityResolver.mjs')).default;
...
test.describe('Neo.ai.mcp.server.shared.services.AuthMiddleware', () => {
    ...
    test.beforeAll(async () => {
        AuthMiddleware = (await import('../../../../../mcp/server/shared/services/AuthMiddleware.mjs')).default;
    });
