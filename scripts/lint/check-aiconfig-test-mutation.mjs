...
export const ALLOWLIST = new Set([
     ...
     */
    'cloud/test/unit/mcp/server/knowledge-base/logger.spec.mjs',
    'cloud/test/unit/mcp/server/memory-core/logger.spec.mjs',
    'test/unit/mcp/server/neural-link/logger.spec.mjs',
    /*
     ...
     */
    'cloud/test/unit/mcp/server/shared/services/DestructiveOperationGuard.spec.mjs',
]);
