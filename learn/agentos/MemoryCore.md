...
*   **[Deploying the Agent OS](https://github.com/neomjs/neo/blob/dev/learn/benefits/brain/DeployingTheAgentOS.md)** — running the Brain on your team's codebase: the multi-tenant cloud topology (running it locally needs no deployment).
